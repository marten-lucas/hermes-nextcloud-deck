...
"""Outbound-Kategorisierung für Gateway-Nachrichten (Deck).

Portierung der Loop-Prävention aus nextcloudtalk-hermes-channel/outbound.py:
Interne Gateway-Meldungen (Lifecycle, Fehler, Fortschritts-Rauschen,
Silence-Narration) werden kategorisiert, bevor sie als Deck-Kommentar
geschrieben werden — sonst spiegelt der Bot seine eigene Infrastruktur
in die Karten.
"""
